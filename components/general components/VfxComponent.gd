...
const COLORS := {
	...
	"charge_normal": Color(0.4, 0.6, 1.5), # Azul suave (carga estágio 1)
	"charge_strong": Color(0.5, 1.0, 0.5), # Verde suave (carga estágio 2)
	"charge_super": Color(1.0, 0.5, 0.5),  # Vermelho suave (carga estágio 3)
	"white": Color.WHITE,
}
